...
class CLI:
    """
    This Class defines the arguments to be calle to use slasher
    For the help, you can use 'slasher -h' or 'slasher --help'
    """
    def __init__(self,):
        """
    ...
    def args(self,):
        ...
        """
        parser = argparse.ArgumentParser(description="Slasher, R. Thomas, 2022, \
                ...
                this code for details.\n website: https://github.com/astrom-tom/Slasher")
        ...
        parser.add_argument("--version", action = "store_true", help="display version of cutter")
